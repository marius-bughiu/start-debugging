...
description: ".NET MAUI 10 has been released in November 2025 along with .NET 10 and C# 14. .NET 10 is a Long Term Support (LTS) version, which will receive free support and patches for 3 years from the release date, up until November 2028. For more information see what’s new in .NET 10 and what’s new…"
pubDate: 2025-04-11
...
tags:
  ...
  - "net-10"
---
.NET MAUI 10 has been released in November 2025 along with .NET 10 and C# 14.  
...
-   Control enhancements
    -   `CollectionView` and `CarrouselView` performance and stability improvements
    -   `HibridWebView.InvokeJavaScriptAsync` overload
...
-   `MessagingCenter` was made internal in .NET 10. Use `WeakReferenceMessenger` from [CommunityTooklit.Mvvm](https://www.nuget.org/packages/CommunityToolkit.Mvvm) instead
