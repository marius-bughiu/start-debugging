...
description: "One of the most important things when it comes to perceived performance is how fast a web page loads when it’s first accessed, and one of the key things in having a fast-loading web page is to only load what’s necessary, when necessary. Of course, this might sound like a lot of work, but there…"
pubDate: 2019-05-01
...
There’s several disadvantages to doing that:
...
-   The previous one can also lead to page ranking penalties being applied by Google, which will favor more web pages which are more responsive.
