...
description: "Use the `dotnet workload clean` command to remove leftover .NET workload packs after an SDK or Visual Studio update — when to use it, what it removes, and gotchas."
pubDate: 2023-09-04
tags:
  - "dotnet"
  - "dotnet-8"
