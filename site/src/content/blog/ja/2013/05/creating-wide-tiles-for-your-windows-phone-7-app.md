...
---
最近 Nokia Developer Wiki で、1 つのコード片で [Windows Phone 7](/ja/2012/01/windows-phone-7-getting-the-current-gps-location-from-the-device/) と Windows Phone 8 の両方で動く live tiles (wide tile を含む) を作る方法に関する記事を見つけました。
