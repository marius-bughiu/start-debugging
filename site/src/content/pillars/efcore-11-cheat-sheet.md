...
For day-to-day query work, [EF Core 11 Prunes Unnecessary Reference Joins in Split Queries](/2026/04/efcore-11-preview-3-prunes-reference-joins-split-queries/) and [EF Core 11 translates Contains to JSON_CONTAINS on SQL Server 2025](/2026/04/efcore-11-json-contains-sql-server-2025/) are the changes you're most likely to feel in generated SQL.
