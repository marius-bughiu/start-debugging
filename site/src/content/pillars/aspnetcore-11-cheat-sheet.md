...
For the request pipeline, [endpoint filters vs middleware](/2026/07/endpoint-filters-vs-middleware-in-aspnetcore-11/) settles that fork; for caching, [output caching vs response caching](/2026/07/output-caching-vs-response-caching-in-aspnetcore-11/) is the call. For background jobs, [BackgroundService vs IHostedService vs Hangfire in .NET 11](/2026/06/backgroundservice-vs-ihostedservice-vs-hangfire-for-background-jobs-in-dotnet-11/) settles the hosting choice. For observability, [OpenTelemetry with .NET 11](/2026/05/how-to-use-opentelemetry-with-dotnet-11-and-a-free-backend/) and [Serilog and Seq](/2026/05/how-to-set-up-structured-logging-with-serilog-and-seq-in-dotnet-11/) are the starting points.
